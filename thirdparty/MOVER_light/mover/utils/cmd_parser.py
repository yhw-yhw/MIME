...
def parse_config(argv=None):
    ...
    parser.add_argument('--scene_dir',
                        default=os.getcwd(),
                        help='the generated scene from MIME.')
    parser.add_argument('--body_dir',
                        default=os.getcwd(),
                        help='input motion dir.')
    ...
    parser.add_argument('--only_rendering', help='True or False flag, input should be either "True" or "False".',
        type=ast.literal_eval, default=False)
    ...
    parser.add_argument('--REINIT_ORIENT_BY_BODY', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
    parser.add_argument('--REINIT_TRANSL_BY_DEPTH', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
    ...
    parser.add_argument('--higherChair', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
    parser.add_argument('--LowerSDFChair', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
    parser.add_argument('--LowerContactTable', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='')
    ...
    parser.add_argument('--degenerate_scale', default=0.1, type=float,
                        help='')
    parser.add_argument('--higherScale', default=100, type=float,
                        help='')
    parser.add_argument('--LowerSDFScale', default=1, type=float,
                        help='')
    parser.add_argument('--LowerContactScale', default=1, type=float,
                        help='')
    ...
    parser.add_argument('--preload_body',
                        type=lambda arg: arg.lower() in ['true', '1'],
                        default=False,
                        help='')
    ...
    ### TODO: chose the last one model as the best one
    ...
    parser.add_argument('--ALL_OBJ_ON_THE_GROUND',
                        ...
                        default=True,
                        help='')
    parser.add_argument('--ONLY_SAVE_FILETER_IMG',
                        type=lambda arg: arg.lower() in ['true', '1'],
                        default=True,
                        help='')
    

    ## constraint chair scale:
    parser.add_argument('--constraint_scale_for_chair',
                        type=lambda arg: arg.lower() in ['true', '1'],
                        default=False,
                        help='')
    parser.add_argument('--chair_scale',
                        default=0.8,
                        type=float,
                        help='')
