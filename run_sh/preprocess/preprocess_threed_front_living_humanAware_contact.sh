...
PATH_TO_SCENES=${PATH_TO_3D_FUTURE_PICKLED_DATA} python preprocess_data_humanAware_FreeContact.py \
    $PATH_TO_OUTPUT_DIR_CLUSTER/${kind}_contact_hand_size_in_touch \
    ...
    --annotation_file ${CODE_ROOT_DIR}/config/living_rooms_threed_front_splits.csv \
    --room_side ${room_side} \
    --interaction \
    --hand_size_in_touch {hand_size_in_touch} \
